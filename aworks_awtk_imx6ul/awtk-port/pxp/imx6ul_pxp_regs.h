...
/**
 * \file
 * \brief Freescale i.MX6UL Pixel Pipeline regs
 *
 * \internal
...
#ifndef __IMX6UL_PXP_REGS_H
#define __IMX6UL_PXP_REGS_H
...
typedef struct {
    ...
    __IO uint32_t CSC2_CTRL;                /**< \brief Color Space Conversion Control Register, offset: 0x1D0 */
         uint8_t  RESERVED_25[12];
    __IO uint32_t CSC2_COEF0;               /**< \brief Color Space Conversion Coefficient Register 0, offset: 0x1E0 */
         uint8_t  RESERVED_26[12];
    __IO uint32_t CSC2_COEF1;               /**< \brief Color Space Conversion Coefficient Register 1, offset: 0x1F0 */
         uint8_t  RESERVED_27[12];
    __IO uint32_t CSC2_COEF2;               /**< \brief Color Space Conversion Coefficient Register 2, offset: 0x200 */
         uint8_t  RESERVED_28[12];
    __IO uint32_t CSC2_COEF3;               /**< \brief Color Space Conversion Coefficient Register 3, offset: 0x210 */
         uint8_t  RESERVED_29[12];
    __IO uint32_t CSC2_COEF4;               /**< \brief Color Space Conversion Coefficient Register 4, offset: 0x220 */
         uint8_t  RESERVED_30[12];
    __IO uint32_t CSC2_COEF5;               /**< \brief Color Space Conversion Coefficient Register 5, offset: 0x230 */
         uint8_t  RESERVED_31[12];
    __IO uint32_t LUT_CTRL;                 /**< \brief Lookup Table Control Register, offset: 0x240 */
         uint8_t  RESERVED_32[12];
    __IO uint32_t LUT_ADDR;                 /**< \brief Lookup Table Address Register, offset: 0x250 */
         uint8_t  RESERVED_33[12];
    __IO uint32_t LUT_DATA;                 /**< \brief Lookup Table Data Register, offset: 0x260 */
         uint8_t  RESERVED_34[12];
    __IO uint32_t LUT_EXTMEM;               /**< \brief Lookup Table External Memory Address Register, offset: 0x270 */
         uint8_t  RESERVED_35[12];
    __IO uint32_t CFA;                      /**< \brief Color Filter Array Register, offset: 0x280 */
         uint8_t  RESERVED_36[12];
    __IO uint32_t HIST_CTRL;                /**< \brief Histogram Control Register, offset: 0x290 */
         uint8_t  RESERVED_37[12];
    __IO uint32_t HIST2_PARAM;              /**< \brief 2-level Histogram Parameter Register, offset: 0x2A0 */
         uint8_t  RESERVED_38[12];
    __IO uint32_t HIST4_PARAM;              /**< \brief 4-level Histogram Parameter Register, offset: 0x2B0 */
         uint8_t  RESERVED_39[12];
    __IO uint32_t HIST8_PARAM0;             /**< \brief 8-level Histogram Parameter 0 Register, offset: 0x2C0 */
         uint8_t  RESERVED_40[12];
    __IO uint32_t HIST8_PARAM1;             /**< \brief 8-level Histogram Parameter 1 Register, offset: 0x2D0 */
         uint8_t  RESERVED_41[12];
    __IO uint32_t HIST16_PARAM0;            /**< \brief 16-level Histogram Parameter 0 Register, offset: 0x2E0 */
         uint8_t  RESERVED_42[12];
    __IO uint32_t HIST16_PARAM1;            /**< \brief 16-level Histogram Parameter 1 Register, offset: 0x2F0 */
         uint8_t  RESERVED_43[12];
    __IO uint32_t HIST16_PARAM2;            /**< \brief 16-level Histogram Parameter 2 Register, offset: 0x300 */
         uint8_t  RESERVED_44[12];
    __IO uint32_t HIST16_PARAM3;            /**< \brief 16-level Histogram Parameter 3 Register, offset: 0x310 */
...
#define __PXP_CTRL_VFLIP_SHIFT             11
...
#define __PXP_CSC2_CTRL_BYPASS_SHIFT      0
#define __PXP_CSC2_CTRL_BYPASS_MASK      (0x1 << __PXP_CSC2_CTRL_BYPASS_SHIFT)
