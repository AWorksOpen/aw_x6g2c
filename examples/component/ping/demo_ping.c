...
aw_local int __shell_ping(int argc, char *argv[], struct aw_shell_user *sh)
{
    aw_local aw_const char help_info[] = {
        "Command:ping target_name [-t] [-n count] [-l size] [-i TTL]" ENDL
        "        ping target_name [-I interval] [-w timeout] [-S srcaddr]" ENDL
            ENDL "Options:" ENDL
    ...
    aw_local aw_const struct aw_shell_cmd tbl[] = {
        {
            __shell_ping,
            "ping",
            "target_name [-t] [-n count] [-l size] [-i TTL] [-w timeout] [-S srcaddr]"
        }
    };
