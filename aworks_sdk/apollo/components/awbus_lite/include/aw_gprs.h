...
#define AW_GPRS_EAPN        1008
/** \brief Network registration status is abnormal */
#define AW_GPRS_ECREG       1009
/** \brief EPS network registration status is abnormal */
#define AW_GPRS_ECEREG      1010
/** \brief GPRS network registration status is abnormal */
#define AW_GPRS_ECGREG      1011
...
/** \brief Device enumeration failed.  */
#define AW_GPRS_EUSBH       1050
