...
/**
 * \file
 * \brief AWBus cyw43455 driver
 *
 * 使用本模块需要包含以下头文件：
 * \code
 * #include "awbl_cyw43455_spi.h"
 * \endcode
 *
 * \internal
...
#ifndef __AWBL_CYW43455_COMMON_H
#define __AWBL_CYW43455_COMMON_H
...
typedef struct awbl_cyw43455_cfg_info {

    /** \brief cyw43455 服务配置信息  */
...
typedef struct cyw43455_dev_common {
    /** \brief wlan服务 */
...
} cyw43455_dev_common_t;

#endif /* __AWBL_CYW43455_COMMON_H */
