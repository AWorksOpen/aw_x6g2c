...
const struct awbl_usbh_fundrv_info_tab awbl_usbh_cdc_serial_info_tab[] = {
        ...
        __HUAWEI_MATCH_INFO(USB_CLASS_VENDOR_SPEC, 0x06, 0x06), /* 华为ME909s-821 Ctrl端口(用于eCall业务)*/
        __HUAWEI_MATCH_INFO(USB_CLASS_VENDOR_SPEC, 0x06, 0x10), /* 华为ME909s-821 MODEM端口*/
        __HUAWEI_MATCH_INFO(USB_CLASS_VENDOR_SPEC, 0x06, 0x12), /* 华为ME909s-821 PCUI端口(用于和上位机应用程序进行AT命令通信)*/
        __HUAWEI_MATCH_INFO(USB_CLASS_VENDOR_SPEC, 0x06, 0x13), /* 华为ME909s-821 DIAG端口(用于调试收集日志信息)*/
        __HUAWEI_MATCH_INFO(USB_CLASS_VENDOR_SPEC, 0x06, 0x1B), /* 华为ME909s-821 Serial B端口(配合Diag口用于模块log收集)*/

		__QUECTEL_MATCH_INFO(0x2C7C, 0x0125),   /* 移远EC20 4G模块*/
		
		__GOSUNCN_MATCH_INFO(0x305a, 0x1415),   /* 高新兴物联GM510 4G模块*/
		
		__L610_MATCH_INFO(0x1782, 0x4D10),      /* FIBOCOM L610 4G模块*/
