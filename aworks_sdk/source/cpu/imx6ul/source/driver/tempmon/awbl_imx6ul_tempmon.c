...
/**
 * \file
 * \brief imx6ul tempmon driver source file
 *
 * \internal
...
/**
 * \brief imx6ul tempmon register block
 */
typedef struct __imx6ul_tempmon_regs {
    uint32_t tempsense0;        /**< \brief tempsense0 */
    uint32_t tempsense0_set;    /**< \brief tempsense0_set */
    uint32_t tempsense0_clr;    /**< \brief tempsense0_clr */
    uint32_t tempsense0_tog;    /**< \brief tempsense0_tog */
    uint32_t tempsense1;        /**< \brief tempsense1 */
    uint32_t tempsense1_set;    /**< \brief tempsense1_set */
    uint32_t tempsense1_clr;    /**< \brief tempsense1_clr */
    uint32_t tempsense1_tog;    /**< \brief tempsense1_tog */
    uint32_t reserved0[60];     /**< \brief reserved */
    uint32_t tempsense2;        /**< \brief tempsense2 */
    uint32_t tempsense2_set;    /**< \brief tempsense2_set */
    uint32_t tempsense2_clr;    /**< \brief tempsense2_clr */
    uint32_t tempsense2_tog;    /**< \brief tempsense2_tog */
} __imx6ul_tempmon_regs_t;
...
#define __IMX6UL_OCOTP_ANA1_ADDR        0x021BC4E0
#define __IMX6UL_XTALOSC24M_MISC0_ADDR  0x020C8150
#define __IMX6UL_CCM_ANALOG_MISC1_ADDR  0x020C8160
...
typedef struct imx6ul_thermal_data {

    uint64_t c1;
    uint64_t c2;        /* See formula in __imx6ul_tempmon_data_calibrate() */

} imx6ul_thermal_data_t;

/** \brief Macro that covert p_serv to awbl_imx6ul_tempmon_dev */
#define __SERV_GET_THERM_DEV(p_serv)   \
        (AW_CONTAINER_OF(p_serv, struct awbl_imx6ul_tempmon_dev, temp_serv))

/** \brief Macro that covert p_serv to awbl_dev */
#define __SERV_GET_DEV(p_serv)   \
        ((AW_CONTAINER_OF(p_serv, struct awbl_imx6ul_tempmon_dev, temp_serv))->dev)

/** \brief Macro that covert p_serv to awbl_imx6ul_tempmon_devinfo */
#define __SERV_GET_THERM_INFO(p_serv) \
        ((struct awbl_imx6ul_tempmon_devinfo *)AWBL_DEVINFO_GET(&__SERV_GET_DEV(p_serv)))

/** \brief Macro that covert struct awbl_dev to awbl_imx6ul_tempmon_dev */
#define __ADEV_GET_TEMPMON_DEV(p_dev) \
    (awbl_imx6ul_tempmon_dev_t *)(p_dev)

/** \brief Macro that covert struct awbl_dev to awbl_imx6ul_tempmon_devinfo */
#define __ADEV_GET_TEMPMON_INFO(p_dev) \
    (awbl_imx6ul_tempmon_dev_info_t *)AWBL_DEVINFO_GET(p_dev)

/* declare tempmon device instance */
#define __TEMPMON_DEV_DECL(p_this, p_dev) \
    struct awbl_imx6ul_tempmon_dev *p_this = \
        (struct awbl_imx6ul_tempmon_dev *)(p_dev)

/*******************************************************************************
  forward declarations
*******************************************************************************/

aw_local void __imx6ul_tempmon_inst_init2 (awbl_dev_t *p_dev);
aw_local void __imx6ul_tempmon_isr (void *p_cookie);
aw_local int  __imx6ul_tempmon_temp_get (void *p_cookie);
aw_local aw_err_t __imx6ul_tempmon_int_state_get (uint8_t *p_int_state);
aw_local aw_err_t __imx6ul_tempmon_data_calibrate (imx6ul_thermal_data_t *data);

/*******************************************************************************
  globals
*******************************************************************************/

static imx6ul_thermal_data_t      __g_imx6ul_thermal_data;
static awbl_imx6ul_tempmon_dev_t *__gp_imx6ul_tempmon_dev;

aw_const struct awbl_drvfuncs __g_imx6ul_tempmon_awbl_drvfuncs = {
    NULL,                               /* devInstanceInit */
    __imx6ul_tempmon_inst_init2,        /* devInstanceInit2 */
    NULL                                /* devConnect */
};
 ...
 */
aw_local aw_const struct awbl_drvinfo __g_imx6ul_tempmon_drv_registration = {
    AWBL_VER_1,                         /* awb_ver */
    AWBL_BUSID_PLB,                     /* bus_id */
    AWBL_IMX6UL_TEMPMON_NAME,           /* p_drvname*/
    &__g_imx6ul_tempmon_awbl_drvfuncs,  /* p_busfuncs */
    NULL,                               /* p_methods */
...
{
    awbl_imx6ul_tempmon_dev_t      *p_dev     = __ADEV_GET_TEMPMON_DEV(p_arg);
    awbl_imx6ul_tempmon_dev_info_t *p_devinfo = __ADEV_GET_TEMPMON_INFO(p_dev);
    __imx6ul_tempmon_regs_t        *p_reg     = (__imx6ul_tempmon_regs_t *)(p_devinfo->regbase);
    ...
    AW_FOREVER {
        ...
        __imx6ul_tempmon_int_state_get(&int_state);

        /* clr corresponding int flag */
        AW_REG_WRITE32(__IMX6UL_CCM_ANALOG_MISC1_ADDR + __REG_CLR,
...
{
    awbl_imx6ul_tempmon_dev_info_t *p_devinfo = __ADEV_GET_TEMPMON_INFO(p_dev);
    awbl_imx6ul_tempmon_dev_t      *p_this    = __ADEV_GET_TEMPMON_DEV(p_dev);
    __imx6ul_tempmon_regs_t        *p_reg     = (__imx6ul_tempmon_regs_t *)(p_devinfo->regbase);
    ...
    /* calibrate */
    __imx6ul_tempmon_data_calibrate(&__g_imx6ul_thermal_data);

    /* load local dev */
    __gp_imx6ul_tempmon_dev = p_this;

    /* set temp limit */
    awbl_imx6ul_tempmon_limit_temp_set(AWBL_IMX6UL_TEMPMON_LIMIT_TEMP_LOW,
                        p_devinfo->low_alarm_temp);     /* set low limit */
    awbl_imx6ul_tempmon_limit_temp_set(AWBL_IMX6UL_TEMPMON_LIMIT_TEMP_HIGH,
                        p_devinfo->high_alarm_temp);    /* set high limit */
    awbl_imx6ul_tempmon_limit_temp_set(AWBL_IMX6UL_TEMPMON_LIMIT_TEMP_PANIC,
    ...
    AW_REG_WRITE32(__IMX6UL_XTALOSC24M_MISC0_ADDR + __REG_SET, AW_BIT(__MISC0_REFTOP_SELBIASOFF));
...
aw_local void __imx6ul_tempmon_isr (void *p_cookie)
{
    awbl_imx6ul_tempmon_dev_t      *p_dev     = __ADEV_GET_TEMPMON_DEV(p_cookie);
    awbl_imx6ul_tempmon_dev_info_t *p_devinfo = __ADEV_GET_TEMPMON_INFO(p_cookie);
...
aw_local int __imx6ul_tempmon_temp_get (void *p_cookie)
{
    awbl_imx6ul_tempmon_dev_info_t *p_devinfo = __SERV_GET_THERM_INFO(p_cookie);
    __imx6ul_tempmon_regs_t        *p_reg     = (__imx6ul_tempmon_regs_t *)(p_devinfo->regbase);
    imx6ul_thermal_data_t          *data      = &__g_imx6ul_thermal_data;
...
aw_local aw_err_t __imx6ul_tempmon_int_state_get (uint8_t *p_int_state)
{
    ...
    /* get int flag */
    int_flag = AW_REG_READ32(__IMX6UL_CCM_ANALOG_MISC1_ADDR);

    if (AW_BIT(__TEMPMON_IRQ_TEMP_PANIC) & int_flag) {
        *p_int_state |= AWBL_IMX6UL_TEMPMON_STATE_TEMP_PANIC;
    }

    if (AW_BIT(__TEMPMON_IRQ_TEMP_LOW) & int_flag) {
        *p_int_state |= AWBL_IMX6UL_TEMPMON_STATE_TEMP_LOW;
    }

    if (AW_BIT(__TEMPMON_IRQ_TEMP_HIGH) & int_flag) {
        *p_int_state |= AWBL_IMX6UL_TEMPMON_STATE_TEMP_HIGH;
    }
...
aw_local aw_err_t __imx6ul_tempmon_data_calibrate (imx6ul_thermal_data_t *data)
{
     ...
     */
    n1 = AW_REG_READ32(__IMX6UL_OCOTP_ANA1_ADDR) >> 20;
    t1 = 25;            /* t1 always 25C */
...
{
    awbl_imx6ul_tempmon_dev_info_t *p_devinfo = __ADEV_GET_TEMPMON_INFO(__gp_imx6ul_tempmon_dev);
    __imx6ul_tempmon_regs_t        *p_reg     = (__imx6ul_tempmon_regs_t *)(p_devinfo->regbase);
    imx6ul_thermal_data_t          *data      = &__g_imx6ul_thermal_data;
    ...
    case AWBL_IMX6UL_TEMPMON_LIMIT_TEMP_LOW:
        AW_REG_BITS_SET32(&p_reg->tempsense2, __TEMPMON_LOW_ALARM,
                                              __TEMPMON_LOW_ALARM_LEN,
                                              temp_value);
        break;

    case AWBL_IMX6UL_TEMPMON_LIMIT_TEMP_HIGH:
    ...
    case AWBL_IMX6UL_TEMPMON_LIMIT_TEMP_PANIC:
...
/**
 * \brief AWBus imx6ul tempmon interrupt enable
 */
...
/**
 * \brief AWBus imx6ul tempmon interrupt disable
 */
...
{
    awbl_imx6ul_tempmon_dev_t      *p_dev     = __gp_imx6ul_tempmon_dev;
    awbl_imx6ul_tempmon_dev_info_t *p_devinfo = __ADEV_GET_TEMPMON_INFO(p_dev);

    /* param invalid? */
    if ((__gp_imx6ul_tempmon_dev == NULL) || (pfn_callback == NULL)) {
        return -AW_EINVAL;
    }
    ...
    if (p_dev->func_exist == 0) {
        ...
        /* connect interrupt */
        aw_int_connect(p_devinfo->inum, __imx6ul_tempmon_isr, p_dev);
    }
...
aw_err_t awbl_imx6ul_tempmon_int_disconnect (void)
{
    ...
    /* param invalid? */
    if (__gp_imx6ul_tempmon_dev == NULL) {
        return -AW_EINVAL;
    }
    ...
    /* connect interrupt */
    aw_int_disconnect(p_devinfo->inum, __imx6ul_tempmon_isr, p_dev);
...
{
    awbl_drv_register(&__g_imx6ul_tempmon_drv_registration);
}
