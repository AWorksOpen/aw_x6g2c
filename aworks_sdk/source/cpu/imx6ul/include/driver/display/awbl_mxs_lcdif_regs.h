/*
 * Freescale ELCDIF Register Definitions
 *
 ...
 * 16-06-12  sky, add elcdif interface
 */
...
#define HW_LCDIF_THRES      (0x00000200)

#define BP_LCDIF_THRES_RSRVD1    25
#define BM_LCDIF_THRES_RSRVD1    0xFE000000
#define BF_LCDIF_THRES_RSRVD1(v) \
        (((v) << 25) & BM_LCDIF_THRES_RSRVD1)
#define BP_LCDIF_THRES_FASTCLOCK    16
#define BM_LCDIF_THRES_FASTCLOCK    0x01FF0000
#define BF_LCDIF_THRES_FASTCLOCK(v) \
        (((v) << 16) & BM_LCDIF_THRES_FASTCLOCK)
#define BP_LCDIF_THRES_RSRVD0    9
#define BM_LCDIF_THRES_RSRVD0    0x0000FE00
#define BF_LCDIF_THRES_RSRVD0(v) \
        (((v) << 9) & BM_LCDIF_THRES_RSRVD0)
#define BP_LCDIF_THRES_PANIC     0
#define BM_LCDIF_THRES_PANIC     0x000001FF
#define BF_LCDIF_THRES_PANIC(v)  \
        (((v) << 0) & BM_LCDIF_THRES_PANIC)

#define HW_LCDIF_AS_CTRL      (0x00000210)

#define BM_LCDIF_AS_CTRL_CSI_VSYNC_ENABLE               0x80000000
#define BM_LCDIF_AS_CTRL_CSI_VSYNC_POL                  0x40000000
#define BM_LCDIF_AS_CTRL_CSI_VSYNC_MOD                  0x20000000
#define BV_LCDIF_AS_CTRL_CSI_VSYNC_MOD__INT_SYNC_MODE   0x0
#define BV_LCDIF_AS_CTRL_CSI_VSYNC_MOD__EXT_SYNC_MODE   0x1
#define BM_LCDIF_AS_CTRL_CSI_SYNC_ON_IRQ_EN             0x10000000
#define BM_LCDIF_AS_CTRL_CSI_SYNC_ON_IRQ                0x08000000
#define BM_LCDIF_AS_CTRL_CSI_SYNC_ON_IRQ__INT_SYNC_MODE 0x0
#define BM_LCDIF_AS_CTRL_CSI_SYNC_ON_IRQ__EXT_SYNC_MODE 0x1
#define BP_LCDIF_AS_CTRL_RSRVD0    24
#define BM_LCDIF_AS_CTRL_RSRVD0    0x07000000
#define BF_LCDIF_AS_CTRL_RSRVD0(v) \
        (((v) << 24) & BM_LCDIF_AS_CTRL_RSRVD0)
#define BM_LCDIF_AS_CTRL_PS_DISABLE                     0x00800000
#define BP_LCDIF_AS_CTRL_INPUT_DATA_SWIZZLE     21
#define BM_LCDIF_AS_CTRL_INPUT_DATA_SWIZZLE     0x00600000
#define BF_LCDIF_AS_CTRL_INPUT_DATA_SWIZZLE(v)  \
        (((v) << 21) & BM_LCDIF_AS_CTRL_INPUT_DATA_SWIZZLE)
#define BV_LCDIF_AS_CTRL_INPUT_DATA_SWIZZLE__NO_SWAP           0x0
#define BV_LCDIF_AS_CTRL_INPUT_DATA_SWIZZLE__LITTLE_ENDIAN     0x0
#define BV_LCDIF_AS_CTRL_INPUT_DATA_SWIZZLE__BIG_ENDIAN_SWAP   0x1
#define BV_LCDIF_AS_CTRL_INPUT_DATA_SWIZZLE__SWAP_ALL_BYTES    0x1
#define BV_LCDIF_AS_CTRL_INPUT_DATA_SWIZZLE__HWD_SWAP          0x2
#define BV_LCDIF_AS_CTRL_INPUT_DATA_SWIZZLE__HWD_BYTE_SWAP     0x3
#define BM_LCDIF_AS_CTRL_ALPHA_INVERT                   0x00100000
#define BP_LCDIF_AS_CTRL_ROP     16
#define BM_LCDIF_AS_CTRL_ROP     0x00600000
#define BF_LCDIF_AS_CTRL_ROP(v)  \
        (((v) << 16) & BM_LCDIF_AS_CTRL_ROP)
#define BV_LCDIF_AS_CTRL_ROP__MASKAS        0x0
#define BV_LCDIF_AS_CTRL_ROP__MASKNOTAS     0x1
#define BV_LCDIF_AS_CTRL_ROP__MASKASNOT     0x2
#define BV_LCDIF_AS_CTRL_ROP__MERGEAS       0x3
#define BV_LCDIF_AS_CTRL_ROP__MERGENOTAS    0x4
#define BV_LCDIF_AS_CTRL_ROP__MERGEASNOT    0x5
#define BV_LCDIF_AS_CTRL_ROP__NOTCOPYAS     0x6
#define BV_LCDIF_AS_CTRL_ROP__NOT           0x7
#define BV_LCDIF_AS_CTRL_ROP__NOTMASKAS     0x8
#define BV_LCDIF_AS_CTRL_ROP__NOTMERGEAS    0x9
#define BV_LCDIF_AS_CTRL_ROP__XORAS         0xA
#define BV_LCDIF_AS_CTRL_ROP__NOTXORAS      0xB
#define BP_LCDIF_AS_CTRL_ALPHA    8
#define BM_LCDIF_AS_CTRL_ALPHA    0x0000FF00
#define BF_LCDIF_AS_CTRL_ALPHA(v) \
        (((v) << 8) & BM_LCDIF_AS_CTRL_ALPHA)
#define BP_LCDIF_AS_CTRL_FORMAT     4
#define BM_LCDIF_AS_CTRL_FORMAT     0x000000F0
#define BF_LCDIF_AS_CTRL_FORMAT(v)  \
        (((v) << 4) & BM_LCDIF_AS_CTRL_FORMAT)
#define BV_LCDIF_AS_CTRL_FORMAT__ARGB8888   0x0
#define BV_LCDIF_AS_CTRL_FORMAT__RGB888     0x4
#define BV_LCDIF_AS_CTRL_FORMAT__ARGB1555   0x8
#define BV_LCDIF_AS_CTRL_FORMAT__ARGB4444   0x9
#define BV_LCDIF_AS_CTRL_FORMAT__RGB555     0xC
#define BV_LCDIF_AS_CTRL_FORMAT__RGB444     0xD
#define BV_LCDIF_AS_CTRL_FORMAT__RGB565     0xE
#define BM_LCDIF_AS_CTRL_ENABLE_COLORKEY                0x00000008
#define BP_LCDIF_AS_CTRL_ALPHA_CTRL     1
#define BM_LCDIF_AS_CTRL_ALPHA_CTRL     0x00000006
#define BF_LCDIF_AS_CTRL_ALPHA_CTRL(v)  \
        (((v) << 1) & BM_LCDIF_AS_CTRL_ALPHA_CTRL)
#define BV_LCDIF_AS_CTRL_ALPHA_CTRL__EMBEDDED   0x0
#define BV_LCDIF_AS_CTRL_ALPHA_CTRL__OVERRIDE   0x1
#define BV_LCDIF_AS_CTRL_ALPHA_CTRL__MULTIPLY   0x2
#define BV_LCDIF_AS_CTRL_ALPHA_CTRL__ROPS       0x3
#define BM_LCDIF_AS_CTRL_AS_ENABLE                      0x00000001

#define HW_LCDIF_AS_BUF         (0x00000220)

#define BP_LCDIF_AS_BUF_ADDR      0
#define BM_LCDIF_AS_BUF_ADDR      0xFFFFFFFF
#define BF_LCDIF_AS_BUF_ADDR(v)   (v)

#define HW_LCDIF_AS_NEXT_BUF    (0x00000230)

#define BP_LCDIF_AS_NEXT_BUF_ADDR      0
#define BM_LCDIF_AS_NEXT_BUF_ADDR      0xFFFFFFFF
#define BF_LCDIF_AS_NEXT_BUF_ADDR(v)   (v)

#define HW_LCDIF_AS_CLRKEYLOW   (0x00000240)

#define BP_LCDIF_AS_CLRKEYLOW_RSRVD0    24
#define BM_LCDIF_AS_CLRKEYLOW_RSRVD0    0xFF000000
#define BF_LCDIF_AS_CLRKEYLOW_RSRVD0(v) \
        (((v) << 24) & BM_LCDIF_AS_CLRKEYLOW_RSRVD0)
#define BP_LCDIF_AS_CLRKEYLOW_PIXEL     0
#define BM_LCDIF_AS_CLRKEYLOW_PIXEL     0x00FFFFFF
#define BF_LCDIF_AS_CLRKEYLOW_PIXEL(v)  \
        (((v) << 0) & BM_LCDIF_AS_CLRKEYLOW_PIXEL)

#define HW_LCDIF_AS_CLRKEYHIGH   (0x00000250)

#define BP_LCDIF_AS_CLRKEYHIGH_RSRVD0    24
#define BM_LCDIF_AS_CLRKEYHIGH_RSRVD0    0xFF000000
#define BF_LCDIF_AS_CLRKEYHIGH_RSRVD0(v) \
        (((v) << 24) & BM_LCDIF_AS_CLRKEYHIGH_RSRVD0)
#define BP_LCDIF_AS_CLRKEYHIGH_PIXEL     0
#define BM_LCDIF_AS_CLRKEYHIGH_PIXEL     0x00FFFFFF
#define BF_LCDIF_AS_CLRKEYHIGH_PIXEL(v)  \
        (((v) << 0) & BM_LCDIF_AS_CLRKEYHIGH_PIXEL)

#define HW_LCDIF_SYNC_DELAY     (0x00000260)

#define BP_LCDIF_SYNC_DELAY_V_COUNT_DELAY    16
#define BM_LCDIF_SYNC_DELAY_V_COUNT_DELAY    0xFFFF0000
#define BF_LCDIF_SYNC_DELAY_V_COUNT_DELAY(v) \
        (((v) << 16) & BM_LCDIF_SYNC_DELAY_V_COUNT_DELAY)
#define BP_LCDIF_SYNC_DELAY_H_COUNT_DELAY     0
#define BM_LCDIF_SYNC_DELAY_H_COUNT_DELAY     0x0000FFFF
#define BF_LCDIF_SYNC_DELAY_H_COUNT_DELAY(v)  \
        (((v) << 0) & BM_LCDIF_SYNC_DELAY_H_COUNT_DELAY)

#define HW_LCDIF_DEBUG3     (0x00000270)

#define BP_LCDIF_DEBUG3_RSRVD0    12
#define BM_LCDIF_DEBUG3_RSRVD0    0xFFFFF000
#define BF_LCDIF_DEBUG3_RSRVD0(v) \
        (((v) << 12) & BM_LCDIF_AS_CTRL_RSRVD0)
#define BP_LCDIF_DEBUG3_CUR_REQ_STATE     10
#define BM_LCDIF_DEBUG3_CUR_REQ_STATE     0x00000C00
#define BF_LCDIF_DEBUG3_CUR_REQ_STATE(v)  \
        (((v) << 10) & BM_LCDIF_DEBUG3_CUR_REQ_STATE)
#define BM_LCDIF_DEBUG3_MST_AVALID               0x00000200
#define BP_LCDIF_DEBUG3_MST_OUTSTANDING_REQS     4
#define BM_LCDIF_DEBUG3_MST_OUTSTANDING_REQS     0x000001F0
#define BF_LCDIF_DEBUG3_MST_OUTSTANDING_REQS(v)  \
        (((v) << 4) & BM_LCDIF_DEBUG3_MST_OUTSTANDING_REQS)
#define BP_LCDIF_DEBUG3_MST_WORDS     0
#define BM_LCDIF_DEBUG3_MST_WORDS     0x0000000F
#define BF_LCDIF_DEBUG3_MST_WORDS(v)  \
        (((v) << 0) & BM_LCDIF_DEBUG3_MST_WORDS)

#define HW_LCDIF_DEBUG4     (0x00000280)

#define BP_LCDIF_DEBUG4_H_DATA_COUNT    16
#define BM_LCDIF_DEBUG4_H_DATA_COUNT    0xFFFF0000
#define BF_LCDIF_DEBUG4_H_DATA_COUNT(v) \
        (((v) << 16) & BM_LCDIF_DEBUG4_H_DATA_COUNT)
#define BP_LCDIF_DEBUG4_V_DATA_COUNT     0
#define BM_LCDIF_DEBUG4_V_DATA_COUNT     0x0000FFFF
#define BF_LCDIF_DEBUG4_V_DATA_COUNT(v)  \
        (((v) << 0) & BM_LCDIF_DEBUG4_V_DATA_COUNT)

#define HW_LCDIF_DEBUG5     (0x00000290)

#define BP_LCDIF_DEBUG5_MST_ADDRESS     0
#define BM_LCDIF_DEBUG5_MST_ADDRESS     0xFFFFFFFF
#define BF_LCDIF_DEBUG5_MST_ADDRESS(v)  (v)
