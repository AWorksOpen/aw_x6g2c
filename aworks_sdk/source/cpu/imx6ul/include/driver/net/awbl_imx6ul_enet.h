...
#ifndef __AWBL_IMX6UL_ENET_H
#define __AWBL_IMX6UL_ENET_H
...
#include "driver/net/imx6ul_enet_regs.h"
...
/** \brief iMX6UL ENET 驱动名称 */
#define AWBL_IMX6UL_ENET_NAME       "awbl_imx6ul_enet"
#define AWBL_IMX6UL_ENET_RX_THREAD_STK_SIZE    2048
...
/** \brief iMX6UL ENET 设备信息 */
struct awbl_imx6ul_enet_devinfo {
...
typedef struct awbl_imx6ul_enet_dev {
    ...
    AW_TASK_DECL(rx_task, AWBL_IMX6UL_ENET_RX_THREAD_STK_SIZE);
    AW_SEMB_DECL(rx_semb);
} awbl_imx6ul_enet_dev_t;
