...
#ifndef __AWBL_IMX6UL_CSI_H
#define __AWBL_IMX6UL_CSI_H
...
#define AWBL_IMX6UL_CSI_NAME   "imx6ul_csi"

/** \brief csi 任务的栈  */
#define __IMX6UL_CSI_TASK_STACK_SIZE    (2*1024)

/** \brief csi 缓冲队列的最大数量 */
#define __IMX6UL_CSI_MSGQ_SIZE          (16)
...
typedef struct __csi_msg{
    AW_SEMC_DECL(sem);
    AW_MUTEX_DECL(lock);
    __csi_list_t array[__IMX6UL_CSI_MSGQ_SIZE];
    __csi_list_t list;
...
typedef struct awbl_imx6ul_csi_devinfo {
...
} awbl_imx6ul_csi_devinfo_t;


/**
 * \brief iMX6UL csi 设备实例
 */
typedef struct awbl_imx6ul_csi_dev {
    ...
    /** \brief csi任务 */
    AW_TASK_DECL(csi_task_decl, __IMX6UL_CSI_TASK_STACK_SIZE);

} awbl_imx6ul_csi_dev_t;

void awbl_imx6ul_csi_drv_register (void);
