...
aw_local aw_const struct awbl_imx6ul_usbh_info  __g_imx6ul_usbh1_info = {
        {IMX6UL_USB1_BUSID},
        1,
        IMX6UL_USBCTRL1_BASE_ADDR,      /**< USB寄存器基地址 */
        IMX6UL_USBPHY1_BASE_ADDR,       /**< USB PHY寄存器基地址 */
        INUM_OTG1_IRQ,                  /**< 中断号 */
        16,                             /**< 如果插入多个U盘，修改该参数*/
        32,                             /**< 如果插入多个U盘，修改该参数*/
        32,
        32,
        NULL,
        __imx6ul_usb_hc1_plfm_init      /**< 平台相关初始化  */
};
