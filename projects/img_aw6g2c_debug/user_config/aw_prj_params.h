...
//#define AW_DEV_GNSS_GPRS                  /* 由 gprs 模块提供的 gps 设备 */
...
#define AW_DRV_USBH_AUDIO                      /**< \brief USB通用音频类*/
#endif
#if defined(AW_COM_USBH) || defined(AW_COM_USBD)
#ifdef AW_DRV_USBH_UVC
#define AW_CFG_USB_MEM_SIZE          (1024 * 1024)  /**< \brief USB协议栈内存使用空间大小 */
#else
...
#define GNSS_ID_GPRS   0
#define GNSS_ID_UBLOX  1

#ifdef AW_DEV_GNSS_UBLOX
#define SYS_DEF_GNSS_ID  AW_DEV_GNSS_UBLOX
#elif defined(AW_DEV_GNSS_GPRS)
#define SYS_DEF_GNSS_ID  GNSS_ID_GPRS
#endif

#ifdef AW_DEV_IMX6UL_TS
#define SYS_TS_ID  "480x272"
#elif defined(AW_DEV_GT911)
#define SYS_TS_ID  "gt911"
#else
